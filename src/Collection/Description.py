...
class CollectionDescription(QtCore.QObject):
    ...
    def save(self):
        ...
        query.prepare("UPDATE description SET title=?, description=?, author=? WHERE id=1")
...
class DescriptionDialog(QtGui.QDialog):
    def __init__(self, collection, parent=None):
        super(DescriptionDialog, self).__init__(parent, Qt.WindowSystemMenuHint)
        ...
        self.descriptionWidget = QtGui.QTextEdit(self.description.description, self)
