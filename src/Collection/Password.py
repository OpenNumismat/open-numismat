...
class PasswordDialog(QtGui.QDialog):
    ...
    def apply(self):
        ...
        if checkPassword(self.collection, text):
            ...
            QtGui.QMessageBox.critical(self, self.tr("Open collection"),
    ...
    def save(self):
        ...
        if checkPassword(self.collection, text):
            ...
            if newPassword != confirmPassword:
                QtGui.QMessageBox.warning(self, self.tr("Change password"),
            ...
            QtGui.QMessageBox.critical(self, self.tr("Change password"),
                                       self.tr("Incorrect password"))
            self.reject()
