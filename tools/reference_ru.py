...
form.addItem('Восьмиугольник')
form.addItem('Двенадцатиугольник')
form.addItem('Десятиугольник')
form.addItem('Испанский цветок')
form.addItem('Квадрат')
form.addItem('Круг')
form.addItem('Круг с отверстием')
form.addItem('Овал')
form.addItem('Прямоугольник')
form.addItem('Пятиугольник')
form.addItem('Треугольник')
form.addItem('Шестиугольник')
